...
if __name__ == "__main__":
    ...
    root = Tk()
    l = AnimatedGIF(root, "C:\\Users\\yyuvr\\Desktop\\Bmax\\all_images\\g.gif")
    l.pack()
    def stopit():
        AnimatedGIF.stop_animation(l)
    but=Button(root,text="stop",command=stopit)
    but.pack()
